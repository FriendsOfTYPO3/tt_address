...
use FriendsOfTYPO3\TtAddress\Hooks\FormEngine\LegacyPluginSelector;
use FriendsOfTYPO3\TtAddress\Hooks\Tca\AddFieldsToSelector;
use TYPO3\CMS\Lang\LanguageService;
use TYPO3\TestingFramework\Core\BaseTestCase;

class LegacyPluginSelectorTest extends BaseTestCase
{
    ...
    public function constructorIsCalled()
    {
        ...
        $subject = $this->getAccessibleMock(LegacyPluginSelector::class, ['dummy'], [], '', true);
    ...
    public function optionsAreFilled()
    {
        ...
        $items = [];
        $subject->addFieldsToSelector($items);
