...
class LatitudeEvaluation
{
  ...
  public function evaluateFieldValue($value, $is_in, &$set)
  {
    ...
    if ($value && $value != "") {
      $value = \TYPO3\TtAddress\Utility\EvalcoordinatesUtility::formatCoordinate($value);
    }
    return $value;
  }
  ...
  public function deevaluateFieldValue(array $parameters)
  {
    ...
    if ($parameters['value'] && $parameters['value'] != "") {
      $parameters['value'] = \TYPO3\TtAddress\Utility\EvalcoordinatesUtility::formatCoordinate($parameters['value']);
    }
