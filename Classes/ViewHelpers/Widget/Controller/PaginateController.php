...
class PaginateController extends \TYPO3\CMS\Fluid\Core\Widget\AbstractWidgetController
{
    ...
    public function initializeAction()
    {
        ...
        //\TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($this->configuration);

        $itemsPerPage = (int) $this->configuration['itemsPerPage'];
//     \TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($this->configuration);
        if ($itemsPerPage === 0) {
            throw new \RuntimeException('The itemsPerPage is 0 which is not allowed. Please also add "itemsPerPage" to the TS setting settings.overrideFlexformSettingsIfEmpty!',
                1400741142);
        }
